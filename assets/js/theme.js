...
var SwiperSlider = function () {
  // Variables
  var swiper = document.querySelectorAll('.swiper'); // Methods
  ...
  function init(elem, index) {
    ...
    if (hasThumb) {
      var dataOptionsThumbs = JSON.parse(elem.querySelector('.swiper-thumbs').getAttribute('data-options')); // Swiper default options for thumbnails
...
var Cube = function () {
  ...
  function rotateCube() {
    ...
    var newStyle = "translateZ(".concat(defaultPerspective, ") rotateY(").concat(lastXDeg, "deg) rotateX(").concat(lastYDeg, "deg)");
